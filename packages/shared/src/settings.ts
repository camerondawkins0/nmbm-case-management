...
export const APP_SETTINGS = {
  ...
  // make it adjustable." The upper bound only guards against a typo
  // turning a window into indefinite access.
  former_worker_access_days: {
    label: "Former case manager access (days)",
    description:
      "How long the last assigned worker can still open a client's record after the case closes. 0 removes access at closure.",
    default: 90,
    min: 0,
    max: 365,
  },
